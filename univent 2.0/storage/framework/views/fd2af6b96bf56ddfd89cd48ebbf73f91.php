...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['events', 'showActions' => false, 'showRevert' => false]));
...
foreach (array_filter((['events', 'showActions' => false, 'showRevert' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
        ...
        <tbody class="divide-y divide-slate-50">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="hover:bg-slate-50/30 transition-colors group">
                    ...
                    <td class="px-6 py-4 text-sm font-bold text-slate-400"><?php echo e($index + 1); ?></td>

                    
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-4">
                            <img src="data:image/jpeg;base64,<?php echo e($event->event_poster); ?>" 
                                class="w-12 h-16 object-cover rounded-xl shadow-sm border border-slate-100 transition-transform group-hover:scale-105">
                            <div>
                                <p class="text-sm font-black text-slate-900 line-clamp-1 italic tracking-tight"><?php echo e($event->event_title); ?></p>
                                <p class="text-[10px] font-bold text-red-500 uppercase tracking-tighter">by <?php echo e($event->organizer_name); ?></p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4 text-center">
                        <span class="px-3 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-full 
                            <?php echo e($event->status === 'approved' ? 'bg-green-100 text-green-600' : 
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showActions || $showRevert): ?>
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($showActions && $event->status === 'pending') || ($showRevert && $event->status === 'rejected')): ?>
                                    <form action="<?php echo e(route('admin.events.approve', $event->id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($showActions && $event->status === 'pending') || ($showRevert && $event->status === 'approved')): ?>
                                    <form action="<?php echo e(route('admin.events.reject', $event->id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
                            ...
                            <a href="<?php echo e(route('admin.events.detail', $event->id)); ?>" 
...
<?php endif; ?>
                            ...
                            <form action="<?php echo e(route('admin.events.delete', $event->id)); ?>" method="POST" class="inline delete-form">
                                <?php echo csrf_field(); ?>
...
</div><?php /**PATH R:\ABp tubes\univent2.0\ABP\univent 2.0\resources\views/partials/event_table.blade.php ENDPATH**/ ?>