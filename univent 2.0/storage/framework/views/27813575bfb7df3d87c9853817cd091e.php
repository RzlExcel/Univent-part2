...
<?php $__env->startSection('header', 'Welcome Back'); ?>
<?php $__env->startSection('subtitle'); ?>
    Don't have an account? <a href="<?php echo e(route('register.form')); ?>" class="font-bold text-red-500 hover:text-pink-500 transition-colors">Sign Up</a>
...
<?php endif; ?>
    ...
    <div x-data="{ show: false }">
        <div class="flex items-center justify-between mb-1.5">
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-bold text-red-500 hover:text-pink-500 transition-colors">Forgot password?</a>
        </div>
        <div class="relative group">
            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400 group-focus-within:text-red-500 transition-colors">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => '!show','class' => 'w-5 h-5']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => 'show','class' => 'w-5 h-5','x-cloak' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <div class="flex items-center">
        <input id="remember" name="remember" type="checkbox" 
            class="h-4 w-4 text-red-500 focus:ring-pink-400 border-gray-300 rounded cursor-pointer transition-all">
...
<div class="mt-6">
    <div class="relative">
        ...
        <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-white text-gray-400 font-medium italic">Or continue with</span>
        </div>
    </div>

    <div class="mt-6">
        <a href="<?php echo e(route('google.redirect')); ?>" class="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-xl bg-white text-sm font-bold text-gray-700 hover:bg-pink-50 hover:border-pink-200 hover:text-pink-600 transition-all shadow-sm">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\ABp tubes\univent2.0\ABP\univent 2.0\resources\views/auth/login.blade.php ENDPATH**/ ?>