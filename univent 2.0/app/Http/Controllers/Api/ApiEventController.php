...
class ApiEventController extends Controller
{
    public function getHomeData(Request $request)
    {
        ...
        return response()->json([
            ...
            'stats' => [
                ...
                'total_users' => (string) $totalUsers,//nanti ganti 
            ],
    ...
    public function submitEvent(Request $request)
    {
        try {
            ...
            if (!$isAdmin) {
                // Ambil semua user yang role-nya admin dari tabel account_roles
                ...
                if ($admins->count() > 0) {
                    ...
                    foreach ($admins as $admin) {
                        FcmService::sendNotification(
                            ...
                            'Terdapat pengajuan event baru: ' . $event->event_title,
                        [
                            'tipe' => 'pengajuan_event',
                            'event_id' => (string) $event->id // Wajib diubah jadi string
                        ]
                        );
                    }
                }
