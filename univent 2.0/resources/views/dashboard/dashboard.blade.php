                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-3 mb-8 mt-4">
                                    ...
                                    <div class="flex items-center gap-3 text-slate-500">
                                        ...
                                        <span class="text-xs font-bold">{{ $event->registrations_count ?? 0 }} Orang
                                            Mendaftar</span>
                                    </div>
                                    {{-- Tanggal --}}
                                    <div class="flex items-center gap-3 text-slate-500">
                            ...
                            <div class="absolute top-4 left-4 flex gap-2">
                                @if ($event->tags)
                                    @foreach (explode(',', $event->tags) as $tag)
                                        <span
                                            class="px-3 py-1 bg-white/90 backdrop-blur-md text-[10px] font-extrabold uppercase tracking-widest text-red-600 rounded-lg shadow-sm">{{ $tag }}</span>
                                    @endforeach
                                @endif
                            </div>
                        </div>
