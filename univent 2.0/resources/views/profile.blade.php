                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div
                        ...
                        <div class="relative group mb-6">
                            ...
                            <img src="{{ $user->avatar ? (strlen($user->avatar) > 200 ? 'data:image/jpeg;base64,' . $user->avatar : asset('storage/' . $user->avatar)) : asset('images/default-avatar.svg') }}"
                                ...
                                <div class="flex items-start gap-4 group">
                                    ...
                                    <div>
                                        <span
                                            ...
                                            Number</span>
                                        <p class="text-slate-700 font-semibold">
                                            {{ $user->profile?->phone ?? 'Not set yet' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
