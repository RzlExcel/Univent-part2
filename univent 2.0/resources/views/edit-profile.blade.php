...
@section('content')
    <div class="min-h-screen bg-slate-50/50 pt-28 pb-20 px-4 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto">
            {{-- Pastikan enctype="multipart/form-data" ada agar file fisik bisa terkirim --}}
                    ...
                    <div
                        ...
                        <div class="relative mb-8">
                            ...
                            <div class="relative w-44 h-44 rounded-full p-1 bg-white shadow-sm">
                                {{-- PENERAPAN JALUR GANDA: Cek jika panjang karakter > 200 = Base64, Jika < 200 = File Storage --}}
                                <img id="avatar-preview"
                                    src="{{ $user->avatar ? (strlen($user->avatar) > 200 ? 'data:image/jpeg;base64,' . $user->avatar : asset('storage/' . $user->avatar)) : asset('images/default-avatar.svg') }}"
                        ...
                        <div class="flex flex-col items-center gap-2">
                            ...
                            {{-- UBAH: name="avatar_file" disesuaikan dengan Controller --}}
