                ...
                <form action="{{ $formAction }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-bold text-slate-700">Event Poster <span
                                class="text-red-500">*</span></label>
                        <div class="relative group" x-data="{ imagePreview: '{{ isset($event->event_poster) ? (strlen($event->event_poster) > 200 ? 'data:image/jpeg;base64,' . $event->event_poster : asset('storage/' . $event->event_poster)) : '' }}' }">
